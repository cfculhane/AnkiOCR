...
install_name_tool -change "/usr/local/Cellar/webp/${WEBP_VERSION}/lib/libwebp.7.dylib" "../../../webp/${WEBP_VERSION}/lib/libwebp.7.dylib" "../../../webp/${WEBP_VERSION}/lib/libwebpmux.3.dylib"
